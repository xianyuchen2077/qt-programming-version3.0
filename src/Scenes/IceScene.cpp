...
IceScene::IceScene(QObject *parent) : Scene(parent)
{
    ...
    // spareWeapon3->setPos(sceneRect().left() + (sceneRect().right() - sceneRect().left()) * 0.25, floorHeight);
    // spareWeapon3->setZValue(5);
    // spareWeapon4->unmount();
    // spareWeapon4->setPos(sceneRect().left() + (sceneRect().right() - sceneRect().left()) * 0.55, floorHeight);
    ...
    // spareHeadEquipment->setPos(sceneRect().left() + (sceneRect().right() - sceneRect().left()) * 0.70, floorHeight);
    // spareHeadEquipment->setZValue(5);
    // spareMedicalItem1->unmount();
    // spareMedicalItem1->setPos(sceneRect().left() + (sceneRect().right() - sceneRect().left()) * 0.5, floorHeight - 330);
